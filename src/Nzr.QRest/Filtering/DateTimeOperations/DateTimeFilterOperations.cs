...
/// </summary>
public record DateTimeFilterOperations : BaseDateTimeFilterOperations<DateTime>, IFilterOperations<DateTime>
{
    /// <summary>
    ...
    public Expression<Func<DateTime, bool>>? ToExpression()
    {
        ...
        {
            expression = expression.And(value => DateOnly.FromDateTime(value) == DateEquals.Value);
        }

        if (TimeEquals.HasValue)
        {
            expression = expression.And(value => TimeOnly.FromDateTime(value) == TimeEquals.Value);
        }
